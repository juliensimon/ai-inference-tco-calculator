...
MODEL_LIBRARY = {
    ...
    "Gemini 3.8 Flash":      {"provider": "Google",    "input": 0.75,  "output": 3.75,  "notes": "Latest Google flagship, GA Sep 2, 2026, 1M context. Promo rate; list $1.50/$7.50 from Jan 1, 2027"},
    "Gemini 3.7 Flash":      {"provider": "Google",    "input": 0.75,  "output": 3.75,  "notes": "Aug 2026. Promo rate; list $1.50/$7.50 from Jan 1, 2027"},
    ...
    "Qwen3.7 Flash":         {"provider": "Alibaba",   "input": 0.03,  "output": 0.13,  "notes": "Model Studio ≤32K tier, 1M context; $0.10/$0.40 to 256K, $0.20/$0.80 above"},
    ...
    "Qwen3.5 397B A17B":     {"provider": "Alibaba",   "input": 0.55,  "output": 3.5,   "notes": "Open-weights 397B MoE (17B active), vision-language. Via OpenRouter; Model Studio first-party $0.60/$3.60"},
    ...
    "Kimi K2.5":             {"provider": "Moonshot",   "input": 0.45,  "output": 2.25,  "notes": "Retired from Moonshot API Aug 31, 2026; third-party hosts via OpenRouter."},
